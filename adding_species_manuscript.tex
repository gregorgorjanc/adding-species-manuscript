...
\author[8]{Jean Cury}
\author[21]{Ignacio Echevarria}
\author[9]{Ahmed Hasan}
% \author[]{Xin Huang}
% \author[]{Leonardo Iasi}
\author[10]{Jana Obšteter}
% \author[]{Vitor Antonio Corrêa Pavinato}
\author[11,12]{David Peede}
% \author[]{Ekaterina Noskova}
% \author[]{Alice Pearson}
% \author[]{Manolo Perez}
\author[6]{Chris Smith}
\author[13]{Jeff Spence}
% \author[2]{Anastasia Teterina}
\author[14]{Per Unneberg}
% \author[]{Juan Manuel Vasquez}
\author[15]{Ryan Waples}
\author[16]{Anthony Wilder Wohns}
\author[17]{Yan Wong}
\author[18]{Reed Cartwright}
\author[19]{Aaron Ragsdale}
\author[20]{Franz Baumdicker}
\author[21]{Gregor Gorjanc}
\author[22]{Ryan Gutenkunst}
\author[17]{Jerome Kelleher}
\author[6]{Andy Kern}
\author[6,23]{Peter Ralph}
\author[24]{Dan Schrider}
\author[25]{Ilan Gronau}
...
\affil[8]{\small{Université Paris-Saclay, CNRS, INRIA, Laboratoire Interdisciplinaire des Sciences du Numérique, UMR 9015 Orsay, France}}
\affil[9]{\small{Computational \& Evolutionary Genomics - Department of Cell and Systems Biology, University of Toronto Mississauga}}
\affil[10]{\small{Agricultural Institute of Slovenia, Department of Animal Science, Hacquetova ulica 17, Ljubljana, Slovenia}}
\affil[11]{\small{Department of Ecology and Evolutionary Biology, Brown University, Providence, RI, USA}}
\affil[12]{\small{Center for Computational Molecular Biology, Brown University, Providence, RI, USA}}
\affil[13]{\small{Department of Genetics, Stanford University School of Medicine, Stanford, CA, 94305}}
\affil[14]{\small{Department of Cell and Molecular Biology, National Bioinformatics Infrastructure Sweden, Science for Life Laboratory, Uppsala University,  Husargatan 3, SE-752 37 Uppsala, Sweden}}
\affil[15]{\small{Department of Biostatistics University of Washington}}
\affil[16]{\small{Broad Institute of MIT and Harvard, Cambridge, MA 02142, USA}}
\affil[17]{\small{Big Data Institute, Li Ka Shing Centre for Health Information and Discovery, University of Oxford, OX3 7LF, UK}}
\affil[18]{\small{Genomics, Evolution, and Bioinformatics, School of Life Sciences and The Biodesign Institute, Arizona State University, Tempe, Arizona}}
\affil[19]{\small{Integrative Biology, University of Wisconsin-Madison, Madison, Wisconsin}}
\affil[20]{\small{Cluster of Excellence - Controlling Microbes to Fight Infections, Eberhard Karls Universität Tübingen, Tübingen, Baden-Württemberg, Germany}}
\affil[21]{\small{The Roslin Institute and Royal (Dick) School of Veterinary Studies, University of Edinburgh, Edinburgh EH25 9RG, UK}}
\affil[22]{\small{Molcular and Cellular Biology, University of Arizona, Tucson, Arizona 85721}}
\affil[23]{\small{Department of Mathematics, University of Oregon, Eugene OR 97402}}
\affil[24]{\small{School of Medicine - Genetics, University of North Carolina at Chapel Hill}}
\affil[25]{\small{Efi Arazi School of Computer Science, Reichman University, Herzliya, Israel}}
